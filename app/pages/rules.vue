<template>
  <main>
    ...
    <section
      class="flex flex-col xl:flex-row xl:space-x-60 space-y-16 xl:space-y-0 mb-16 md:mb-32"
    >
      <TheMaterial />
      <GoalOfTheGame />
    </section>
    <section>
      ...
      <p class="mb-5">
        Le nombre de déplacement restant est représenté sur chaque pion et
        réinitialisé en fin de tour.
      </p>
      <div class="flex justify-center mb-32">
        <PawnDisplay
          size-class="size-16"
          color-class="bg-dark-light"
      ...
      <div class="flex flex-col space-y-16 mb-20">
        <div
          class="flex flex-col xl:flex-row xl:space-x-32 space-x-0 xl:space-y-0 space-y-16"
        >
          <MoveRules />
          <RotateRules />
        </div>
    ...
    <RouterLink v-button-click-sound to="/play" class="button mb-20">
